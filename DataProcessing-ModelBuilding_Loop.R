...
# Read in each bent training and test data set --------------------------------------------------------------
...
for (i in 1:length(myTrainFiles)){
  ...
  # Generate an updated training and test set containing only descriptors selected by lasso lambda min model
  ...
  # Generate an updated training and test set containing only descriptors selected by lasso lambda 1se model
  ...
  # Generate a training and test set containing only descriptors selected by mars model
  ...
  ## Generate output files summarizing model statistics for current train/test split
  ...
  fileName = paste0("BentConsensusStats", "_", fileNumbers[i], ".csv")
